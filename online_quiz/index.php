...
<a href="about.txt" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">KAVYA U</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1"></h4>
		<h4 style="font-family:'typo' ">kavyakushi19@gmail.com</h4>
		<h4 style="font-family:'typo' ">India</h4></div></div>
		</p>
      </div>
